...
from FakeNewsIdentification import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Welfake_Type/$', remoteuser.Predict_Welfake_Type, name="Predict_Welfake_Type"),
    ...
    url(r'^View_Welfake_Type_Ratio/$', serviceprovider.View_Welfake_Type_Ratio, name="View_Welfake_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Welfake_Type/$', serviceprovider.View_Prediction_Of_Welfake_Type, name="View_Prediction_Of_Welfake_Type"),
